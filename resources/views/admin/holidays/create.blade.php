...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Add Holiday</h1>
        </div>
        <p class="text-sm text-gray-600 ml-8">Create a new public or special holiday entry</p>
    </div>
        ...
        <form action="{{ route('admin.holidays.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea id="remarks" name="remarks" rows="3"
                          ...
                          placeholder="Optional notes about this holiday...">{{ old('remarks') }}</textarea>
                @error('remarks')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
