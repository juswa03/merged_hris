...
<div class="container mx-auto px-4 py-6">
        <!-- Header -->
        <x-admin.page-header title="Tax Reports & Calculations" description="Manage tax withholding, generate Form 2316, and view tax compliance reports" />

        <!-- Quick Actions -->
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <a href="{{ route('admin.payroll.tax-reports.brackets') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition border-l-4 border-blue-500">
            ...
            <a href="{{ route('admin.payroll.tax-reports.comparison') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition border-l-4 border-green-500">
                <div class="flex items-center">
            ...
            @if($selectedPeriod)
            <a href="{{ route('admin.payroll.tax-reports.export', $selectedPeriod->id) }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition border-l-4 border-orange-500">
                <div class="flex items-center">
        ...
        <!-- Period Selector -->
        <x-admin.card title="Select Payroll Period" class="mb-6">
            <form method="GET" class="flex gap-4 items-end">
                <div class="flex-1">
                    <label class="block text-sm font-medium text-slate-700 mb-2">Payroll Period</label>
                    <select name="period_id" onchange="this.form.submit()" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <x-admin.gradient-stat-card
                ...
                :value="'₱' . number_format($taxReport['total_gross_income'], 2)"
            ...
            <x-admin.gradient-stat-card
                ...
                :value="'₱' . number_format($taxReport['total_tax_withheld'], 2)"
            ...
            <x-admin.gradient-stat-card
                ...
                :value="number_format($taxReport['average_tax_rate'], 2) . '%'"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <x-admin.card title="Tax Distribution by Bracket">
                <div class="space-y-3">
            ...
            <x-admin.card title="Tax Compliance Summary">
                <div class="space-y-4">
        ...
        <x-admin.card title="Employee Tax Breakdown" :padding="false">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-6 py-4 text-sm font-medium text-slate-900">
                                <a href="{{ route('admin.payroll.tax-reports.employee-details', ['employee' => $emp['employee_id']]) }}" class="text-blue-600 hover:text-blue-900">
                                    {{ $emp['employee_name'] }}
                                </a>
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm">
                                <a href="{{ route('admin.payroll.tax-reports.employee-details', ['employee' => $emp['employee_id']]) }}" class="text-blue-600 hover:text-blue-900 font-medium">
                                    View Details
                                </a>
                            </td>
                        </tr>
        ...
        @else
        <x-admin.empty-state icon="fas fa-file-invoice" title="No Report Selected" description="Select a payroll period to view tax reports" />
        @endif
</div>
...
function calculateTax(event) {
    ...
    fetch('{{ route("admin.payroll.tax-reports.calculate") }}', {
        method: 'POST',
        headers: {
