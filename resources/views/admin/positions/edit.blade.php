...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Update position information</p>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.positions.update', $position->id) }}" method="POST" class="bg-white rounded-lg shadow-md">
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="Entry Level" {{ old('level', $position->level) == 'Entry Level' ? 'selected' : '' }}>Entry Level</option>
                            <option value="Mid Level" {{ old('level', $position->level) == 'Mid Level' ? 'selected' : '' }}>Mid Level</option>
                            <option value="Senior Level" {{ old('level', $position->level) == 'Senior Level' ? 'selected' : '' }}>Senior Level</option>
            ...
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        >{{ old('requirements', $position->requirements) }}</textarea>
