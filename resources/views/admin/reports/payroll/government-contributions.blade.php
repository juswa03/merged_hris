...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        ...
        <div class="flex justify-between items-center">
            <form action="{{ route('payroll.reports.government-contributions') }}" method="GET">
            ...
            @if($period)
            <a href="{{ route('payroll.reports.export-government-contributions-csv', ['period_id' => $period->id]) }}"
