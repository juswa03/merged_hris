...
<div class="mx-auto px-4 py-8 max-w-4xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('employees.travel.store') }}" method="POST" x-data="travelApplicationForm()" @submit.prevent="validateAndSubmit">
            @csrf
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <select name="recommending_official_id" id="recommending_official_id" required
                    ...
                    @foreach($recommendingOfficials as $official)
                        <option value="{{ $official->id }}" {{ old('recommending_official_id') == $official->id ? 'selected' : '' }}>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg" :disabled="isSubmitting">
                    <span x-show="!isSubmitting">Submit Travel Authority</span>
...
function travelApplicationForm() {
    return {
        ...
        validateAndSubmit() {
            // Validate signature was uploaded
            const signatureData = document.getElementById('signature_image_base64')?.value;
