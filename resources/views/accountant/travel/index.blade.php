...
<div class="container mx-auto px-4 py-8">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Travel Requests - Accountant Review</h1>
        <p class="text-gray-600">Review travel requests and verify funds availability</p>
    </div>
                        ...
                        @foreach($travels as $travel)
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50 travel-row"
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('accountant.travel.show', $travel) }}" 
